...
import com.example.tugas_pab.network.TarikSaldoRequest
...
class TarikSaldoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tilProvider = findViewById<com.google.android.material.textfield.TextInputLayout>(R.id.til_provider)
        val actvProvider = findViewById<AutoCompleteTextView>(R.id.actv_provider)
        ...
        fun updateUI() {
            ...
            if (metodePenarikan == "Tunai") {
                ...
                tilProvider.visibility = View.GONE
                ...
                tilProvider.visibility = View.VISIBLE
                ...
                val adapter = ArrayAdapter(this, android.R.layout.simple_dropdown_item_1line, bankList)
                ...
                val adapter = ArrayAdapter(this, android.R.layout.simple_dropdown_item_1line, ewalletList)
                actvProvider.setAdapter(adapter)
            }
        }
        ...
        findViewById<View>(R.id.btn_ajukan).setOnClickListener {
            ...
            val finalRekening = if (metodePenarikan == "Tunai") {
                ...
                val provider = actvProvider.text.toString()
                if (provider.isEmpty() || provider == "Pilih Provider Bank / E-Wallet") {
                    Toast.makeText(this, "Harap pilih provider", Toast.LENGTH_SHORT).show()
                    return@setOnClickListener
                }
