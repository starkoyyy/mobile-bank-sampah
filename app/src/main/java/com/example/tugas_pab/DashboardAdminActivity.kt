        ...
        bottomNav.setOnItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.navigation_submission -> {
                    Toast.makeText(this, "Silakan lihat daftar persetujuan di layar utama", Toast.LENGTH_SHORT).show()
                    true
                }
    ...
    private fun setupPersetujuanCard(index: Int, item: PersetujuanItem?) {
        ...
        if (item != null) {
            ...
            btnSetujui.setOnClickListener {
                val intent = Intent(this, DetailPersetujuanActivity::class.java).apply {
